...
const navSections = [
  {
    ...
    items: [
      ...
      { to: '/sessions', label: 'Tài khoản', end: false },
      { to: '/roster', label: 'Sổ tài khoản', end: false },
      { to: '/groups', label: 'Nhóm & kênh', end: false },
      { to: '/dialogs', label: 'Tin nhắn', end: false },
      { to: '/tasks', label: 'Tác vụ hàng loạt', end: false },
      { to: '/conversation', label: 'Hội thoại tự nhiên', end: false },
    ],
  },
  {
    label: 'Cài đặt',
  ...
  },
  {
    label: 'Hệ thống',
    items: [
      { to: '/audit', label: 'Nhật ký hoạt động', end: false },
      { to: '/health', label: 'Trạng thái API', end: false },
    ],
  },
]
